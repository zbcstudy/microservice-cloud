package com.wondertek.springcloud.elasticjob.parse;
...
import com.wondertek.springcloud.elasticjob.base.JobAttributeTag;
 ...
 */
public class JobConfParse implements ApplicationContextAware {

    public static final Logger logger = LoggerFactory.getLogger(JobConfParse.class);
    ...
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        ...
        for (Object confBean : beanMap.values()) {
            ...
            SpringJobScheduler springJobScheduler = (SpringJobScheduler) applicationContext.getBean(jobName+"SpringJobScheduler");
